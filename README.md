...
# Objective.
Develop and AI object tracker/recognizer using the powerfull NPU unit available on the board to identify people/objects based on [YOLO AI pretrained Model](https://milkv.io/docs/duo/application-development/tdl-sdk/tdl-sdk-yolov8) and streaming directly through local host server.
